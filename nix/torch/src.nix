...
assert version == "2.9.0.dev20250811";
(rec {
  src_ = fetchFromGitHub {
    owner = "pytorch";
    repo = "pytorch";
    rev = "113daf02cb4f697c90ed023c19e5b19f984c7539";
    hash = "sha256-EVsZ7wJmdsq5fBCKfwUfCQO5ZBl4qhm2Xdy6EFvvfQk=";
  };
  ...
  src_cutlass_fbgemm = fetchFromGitHub {
    owner = "jwfromm";
    repo = "cutlass";
    rev = "b40777404c174b9694a870bff5c13ce6b7f656ad";
    hash = "sha256-pW9piNy9ErrOIO9ixZACU8NHcDYuEsTuziCZaNM1Omg=";
  };
  ...
  src_fbgemm = fetchFromGitHub {
    owner = "pytorch";
    repo = "fbgemm";
    rev = "21c7d30c526c0f1ad873ecc632dca6cfa8a69067";
    hash = "sha256-D5Dfi6S6u75Uk3Rrw2JM8IrhA8nOLoSivPnOevU3d+M=";
  };
