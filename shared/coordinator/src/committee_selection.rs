...
pub const COOLDOWN_SALT: &str = "cooldown";
...
impl CheckpointerSelection {
    ...
    pub fn get_checkpointer(&self, client_index: u64, total_clients: u64) -> bool {
        let mut final_seed = [0u8; 32];
        final_seed.copy_from_slice(&sha256v(&[&sha256(&self.seed), COOLDOWN_SALT.as_bytes()]));
