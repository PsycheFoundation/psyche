...
pub struct TrainArgs {
    ...
    /// If present, output some metrics via this TCP bind address in JSON format. Useful for debugging or local integration.
    /// Example: METRICS_LOCAL_BIND=127.0.0.1:8080
    #[clap(long, env)]
