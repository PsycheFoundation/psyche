...
1. `cd backend`, `pnpm dev-localnet` in another terminal. This will build the WASM for deserializing the onchain state, build the IDL for interacting with the contracts, and start the backend.
