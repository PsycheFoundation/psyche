...
pub async fn run() {
    ...
    // Coordinator model
    // NOTE: fields like architecture, data_type, data_location, lr_schedule, optimizer
    // have been moved off-chain to ModelExtraData - they are no longer on the LLM struct.
    // This fixture was created with the old layout so deserialized values may be wrong.
